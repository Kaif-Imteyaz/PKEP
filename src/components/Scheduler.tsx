    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4">
          <MeetingCard title="Team Sync" time="10:00 AM - 11:00 AM" attendees={4} />
          <MeetingCard title="Project Review" time="2:00 PM - 3:30 PM" attendees={6} />
          <MeetingCard title="Knowledge Sharing" time="4:00 PM - 5:00 PM" attendees={8} />
        </div>
      </div>
    </div>
  )
