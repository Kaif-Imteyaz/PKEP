      ...
      {articles.map((article) => (
        <div key={article.id} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="text-indigo-600 text-sm font-medium hover:text-indigo-700">Read More →</button>
          </div>
        </div>
      ))}
    </div>
      ...
      {isMinimized ? (
        ...
        <div className="bg-white rounded-xl shadow-lg w-full sm:w-96">
          <div className="p-4 border-b flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button onClick={() => setIsMinimized(true)} className="p-1 hover:bg-gray-100 rounded-full">
          ...
          <div className="h-96 p-4 overflow-y-auto">{/* Chat messages would go here */}</div>
          <div className="p-4 border-t">
            <div className="flex space-x-2">
              ...
              />
              <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Send</button>
            </div>
          </div>
        </div>
      )}
